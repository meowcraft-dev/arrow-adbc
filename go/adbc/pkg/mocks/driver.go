...
// const char* MocksArrayStreamGetLastError(struct ArrowArrayStream*);
// void MocksArrayStreamRelease(struct ArrowArrayStream*);
//
// int MocksArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int MocksArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
import (
	...
	"github.com/apache/arrow-adbc/go/adbc/driver/mocks"
...
var drv = mocks.NewDriver(mallocator.NewMallocator())
...
const errPrefix = "[Mocks] "
const logLevelEnvVar = "ADBC_DRIVER_MOCKS_LOG_LEVEL"
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.malloc(C.sizeof_struct_MocksError)
	cErr := (*C.struct_MocksError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.MocksReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "Mocks driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in Mocks driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("Mocks does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "Mocks: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.MockserrRelease(cStream.adbcErr)
		} else {
...
//export MocksArrayStreamGetLastError
func MocksArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.MocksArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export MocksArrayStreamGetNext
func MocksArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.MocksArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export MocksArrayStreamGetSchema
func MocksArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.MocksArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export MocksArrayStreamRelease
func MocksArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.MocksArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export MocksErrorFromArrayStream
func MocksErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.MocksArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.MocksArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.MocksArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.MocksArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.MocksArrayStreamRelease)
...
//export MocksDatabaseGetOption
func MocksDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseGetOptionBytes
func MocksDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseGetOptionDouble
func MocksDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseGetOptionInt
func MocksDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseInit
func MocksDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseNew
func MocksDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseRelease
func MocksDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export MocksDatabaseSetOption
func MocksDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseSetOptionBytes
func MocksDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseSetOptionDouble
func MocksDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDatabaseSetOptionInt
func MocksDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetOption
func MocksConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetOptionBytes
func MocksConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetOptionDouble
func MocksConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetOptionInt
func MocksConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionNew
func MocksConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionSetOption
func MocksConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionSetOptionBytes
func MocksConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionSetOptionDouble
func MocksConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionSetOptionInt
func MocksConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionInit
func MocksConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionRelease
func MocksConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionCancel
func MocksConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetInfo
func MocksConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetObjects
func MocksConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export MocksConnectionGetStatistics
func MocksConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetStatisticNames
func MocksConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export MocksConnectionGetTableSchema
func MocksConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionGetTableTypes
func MocksConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionReadPartition
func MocksConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionCommit
func MocksConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksConnectionRollback
func MocksConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementGetOption
func MocksStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementGetOptionBytes
func MocksStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementGetOptionDouble
func MocksStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementGetOptionInt
func MocksStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementNew
func MocksStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementRelease
func MocksStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementCancel
func MocksStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementPrepare
func MocksStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementExecuteQuery
func MocksStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementExecuteSchema
func MocksStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export MocksStatementSetSqlQuery
func MocksStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementSetSubstraitPlan
func MocksStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementBind
func MocksStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementBindStream
func MocksStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementGetParameterSchema
func MocksStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementSetOption
func MocksStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementSetOptionBytes
func MocksStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementSetOptionDouble
func MocksStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementSetOptionInt
func MocksStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksStatementExecutePartitions
func MocksStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export MocksDriverInit
func MocksDriverInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.MocksDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.MocksDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.MocksDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.MocksDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.MocksConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.MocksConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.MocksConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.MocksConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.MocksConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.MocksConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.MocksConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.MocksConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.MocksConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.MocksConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.MocksConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.MocksStatementNew)
	driver.StatementRelease = (*[0]byte)(C.MocksStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.MocksStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.MocksStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.MocksStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.MocksStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.MocksStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.MocksStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.MocksStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.MocksStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.MocksStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.MocksErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.MocksErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.MocksErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.MocksDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.MocksDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.MocksDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.MocksDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.MocksDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.MocksDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.MocksDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.MocksConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.MocksConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.MocksConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.MocksConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.MocksConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.MocksConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.MocksConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.MocksConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.MocksConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.MocksConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.MocksStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.MocksStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.MocksStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.MocksStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.MocksStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.MocksStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.MocksStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.MocksStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.MocksStatementSetOptionInt)
	}
